...
package body SSD1306 is
   ...
   Bit_Masks : constant array (0 .. 7) of I2C.Uint8 :=
   ...
   procedure Write_Command (Cmd : I2C.Uint8) is
      ...
      Success : Boolean;
   begin
      Success := I2C_WriteBuffer (SSD1306_ADDR, Cmd_Buffer, 2);  -- CORREGIDO: tercer parámetro es 2 (Uint8 literal)
      if not Success then
   ...
   procedure Write_Data (Data : I2C.Uint8) is
      Data_Buffer : I2C.Uint8_Array (1 .. 2) := (CONTROL_BYTE_DATA, Data);
      Success : Boolean;
   begin
      Success := I2C_WriteBuffer (SSD1306_ADDR, Data_Buffer, 2);  -- CORREGIDO: tercer parámetro es 2
   end Write_Data;
   ...
   begin
      ...
      Success := I2C_WriteBuffer (SSD1306_ADDR, Tx_Buffer, I2C.Uint8 (Len + 1));  -- CORREGIDO: tercer parámetro correcto
